...
const UserRegister = () => {
  ...
  return (
    <>
  <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2  mt-10 bg-red-40 border  border-custom-yellow rounded-xl h ">
       
        <div className="  lg:p-10 m-10 md:m-10">
          <h5 className="text-4xl font-sansation font-bold py-5 ">Register</h5>
          ...
          <div className="text-center ">
            <p className="font-sansation font-regular mt-3">
              ...
              <span className="font-sansation font-bold hover:cursor-pointer hover:text-custom-yellow" onClick={()=>navigate('/user/login')}>
                Sign in
              </span>
            </p>
          </div>
